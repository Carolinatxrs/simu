								...
								<div class="col-md-12">
									<div class="panel">
										...
										<div class="panel-body">
											...
											<div class="container">
												<div class="row">
													<form class="form-horizontal" action="../action/cad_prova.php" method="POST" enctype="multipart/form-data" autocomplete="off">
														<div class="form-group">
															<label for="default" class="col-md-2 control-label">Exame</label>
															<div class="col-sm-6">
																<select id="mySelect" class="form-control" name="exame_p" required autofocus>
														...
														<div id="inputOculto" class="form-group">
															...
															<div  class="col-sm-6">
																<select class="form-control" name="area_p">
														...
														<div class="form-group">
															...
															<div class="col-sm-6">
																<input type="text" class="form-control" name="ano_p" maxlength="4" pattern=".{4,}" title="preencha os 4 caracteres" placeholder="Digite o ano da prova" required autofocus>
															</div>
															<div class="help-block with-errors text-danger"></div>
														</div>

														<div class="form-group">
															<label for="default" class="col-sm-2 control-label">Anexar</label>
															<div class="col-sm-6">
																<input type="file" class="form-control" name="doc_p" placeholder="Selecione um arquivo"  required autofocus>
															</div>
														</div>
